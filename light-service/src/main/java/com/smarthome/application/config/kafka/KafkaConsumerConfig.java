...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, LightChangeEvent> consumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        JsonDeserializer<LightChangeEvent> valueDeserializer = new JsonDeserializer<>(LightChangeEvent.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, LightChangeEvent> kafkaListenerContainerFactory(ConsumerFactory<String, LightChangeEvent> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, LightChangeEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    public KafkaListenerEndpointRegistrar kafkaListenerEndpointRegistrar(ConcurrentKafkaListenerContainerFactory<String, LightChangeEvent> kafkaListenerContainerFactory,
