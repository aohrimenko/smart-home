...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, ClimateChangeEvent> consumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        JsonDeserializer<ClimateChangeEvent> valueDeserializer = new JsonDeserializer<>(ClimateChangeEvent.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ClimateChangeEvent> kafkaListenerContainerFactory(ConsumerFactory<String, ClimateChangeEvent> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, ClimateChangeEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    public KafkaListenerEndpointRegistrar kafkaListenerEndpointRegistrar(ConcurrentKafkaListenerContainerFactory<String, ClimateChangeEvent> kafkaListenerContainerFactory,
