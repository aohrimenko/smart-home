...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, HomeThemeEvent> consumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        JsonDeserializer<HomeThemeEvent> valueDeserializer = new JsonDeserializer<>(HomeThemeEvent.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, HomeThemeEvent> kafkaListenerContainerFactory(ConsumerFactory<String, HomeThemeEvent> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, HomeThemeEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    public KafkaListenerEndpointRegistrar kafkaListenerEndpointRegistrar(final ConcurrentKafkaListenerContainerFactory<String, HomeThemeEvent> kafkaListenerContainerFactory,
